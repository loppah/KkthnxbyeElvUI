...
L["Show Aura From Other Players"] = "Любой юнит"
...
L["Block Non-Whitelisted Auras"] = "Блокировать ауры вне Белого Списка"
...
L["Show When Not Active"] = "Показывать отсутствие" --buff indicator filter option
