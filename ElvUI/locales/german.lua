...
L["Button Size"] = "Tastengröße" --Also used in Bags
L["Button Spacing"] = "Tastenabstand" --Also used in Bags
...
L["Multiply the backdrops height or width by this value. This is usefull if you wish to have more than one bar behind a backdrop."] = "Multipliziere die Höhe und die Breite des Hintergrundes. Das ist nützlich wenn du mehr als eine Leiste hinter einen Hintergrund haben möchtest."
...
L["The amount of buttons to display."] = "Anzahl der angezeigten Tasten."
...
L["The first button anchors itself to this point on the bar."] = "Die erste Taste ankert sich an diesen Punkt in der Leiste."
L["The size of the action buttons."] = "Die Größe der Aktionstasten."
L["Threshold before text turns red and is in decimal form. Set to -1 for it to never turn red"] = "CD-Schwelle bevor der Text rot wird. Setze diese auf -1, wenn es nie Rot werden soll"
...
L['Hold Control + Right Click:'] = 'Halte Steuerung + Rechts Klick:'
...
L['The display format of the currency icons that get displayed below the main bag. (You have to be watching a currency for this to display)'] = 'Das Anzeigeformat für die Währungssymbole, welche unter der Haupttasche angezeigt werden. (Du musst eine Währung beobachten um diese angezeigt zu bekommen)'
...
L['Threshold before text changes red, goes into decimal form, and the icon will fade. Set to -1 to disable.'] = 'Die Schwelle bevor der Text rot und das Symbol verblassen wird (in Dezimalform). Setze sie auf -1 um sie zu deaktivieren.'
L['Time'] = 'Zeit'
...
L['Automatically select greed or disenchant (when available) on green quality items. This will only work if you are the max level.'] = 'Automatisch Gier oder Entzauberung auf Gegenstände von grüner Qualität wählen (sofern verfügbar). Das funktioniert nur, wenn du das maximale Level erreicht hast.'
...
L["Color some texts use."] = "Farbe von einigen Texten";
...
L["Toggle Chat Frame"] = "Chatfenster umschalten" --layout\layout.lua
L["XP:"] = "EP:"
...
L["Controls the height of the nameplate's castbar"] = "Kontrolliert die Höheder Zauberleiste der Namensplaketten"
...
L['ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab.'] = 'ElvUI hat ein Feature für Dualspezialisierung das dich abhängig von deiner momentanen Spezialisierung verschiedene Profile laden lässt. Dies kannst du im Abschnitt Profil aktivieren.'
L['For technical support visit us at http://www.tukui.org.'] = 'Für technische Hilfe besuche uns unter http://www.tukui.org.'
L['If you accidently remove a chat frame you can always go the in-game configuration menu, press install, go to the chat portion and reset them.'] = 'Wenn du ausversehn das Chatfenster entfernen solltest, kannst du ganz einfach in die Ingame Konfiguration gehn und den Installationsprozess aufrufen. Drücke Installieren und gehe zu den Chateinstellungen und setze diese zurück.'
L['If you are experiencing issues with ElvUI try disabling all your addons except ElvUI, remember ElvUI is a full UI replacement addon, you cannot run two addons that do the same thing.'] = 'Wenn du Probleme mit ElvUI hast, deaktiviere alle Addons außer ElvUI. Denke auch daran, dass  ElvUI die komplette Benutzeroberfläche ersetzt, du kannst also kein  Addon verwenden, welches die gleichen Funktionen wie ElvUI nutzt.'
...
L['The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of ElvUI.'] = 'Die Stärkungszauberleiste rechts neben der Minimap ist eine Liste der zusammengesetzten Stärkungszauber. Du kannst diese in den Stärkungs- und Schwachungszauber-Optionen in ElvUI deaktivieren.'
L['The focus unit can be set by typing /focus when you are targetting the unit you want to focus. It is recommended you make a macro to do this.'] = 'Das Fokusfenster kann durch Eingabe von /fokus, während du ein Ziel hast, gesetzt werden. Es wird empfohlen ein Makro dafür zu nutzen.'
L['To move abilities on the actionbars by default hold shift + drag. You can change the modifier key from the actionbar options menu.'] = 'Um Fähigkeiten auf der Aktionsleiste zu verschieben nutze shift + bewegen der Maus. Du kannst die Modifier-Taste im Aktionsleistenmenü umstellen.'
L['To setup which channels appear in which chat frame, right click the chat tab and go to settings.'] = 'Um einzustellen welcher Kanel im welchem Chatfenster angezeigt werden soll, klicke rechts auf das Chattab und gehe auf Einstellungen.'
...
L['You can see someones average item level of their gear by holding shift and mousing over them. It should appear inside the tooltip.'] = 'Du kannst das durchscnittliche Gegenstandslevel von jemanden sehen, wenn du bei gedrückter Shift-Taste mit der Maus über ihn fährst. Es wird dann im Tooltip angezeigt.'
...
L["Show Aura From Other Players"] = "Jede Einheit"
...
L["Show When Not Active"] = "Zeige fehlendes"
