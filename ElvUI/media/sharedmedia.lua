...
LSM:Register("font", "Oswald Regular", [[Interface\AddOns\ElvUI\media\fonts\Oswald-Regular.ttf]])-- Added By Kkthnxbye
LSM:Register("font", "Oswald Light", [[Interface\AddOns\ElvUI\media\fonts\Oswald-Light.ttf]])-- Added By Kkthnxbye
LSM:Register("font", "Oswald Bold", [[Interface\AddOns\ElvUI\media\fonts\Oswald-Bold.ttf]])-- Added By Kkthnxbye
LSM:Register("font", "BigNoodleTitling", [[Interface\AddOns\ElvUI\media\fonts\BigNoodleTitling.ttf]])-- Added By Kkthnxbye
...
LSM:Register("statusbar","Normal", [[Interface\AddOns\ElvUI\media\textures\Normal.tga]])-- Added By Kkthnxbye
