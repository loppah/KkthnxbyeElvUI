...
L["Adds the chat commands |cff00ff96/pets|r and |cff00ff96/mounts|r to provide information about your mounts and pets."] = true
...
L["Log Notice"] = true
L["Log is empty."] = true
L["Logs the lines that are filtered by the |cff00ff96%s|r, |cff00ff96%s|r, |cff00ff96%s|r, and |cff00ff96%s|r modules."] = true
...
L["Use %sECT|r instead of %sElvUI_ChatTweaks|r in messages printed by the addon."] = true
