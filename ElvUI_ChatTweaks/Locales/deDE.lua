...
L["Add an |cff00ff00/emotes|r command to see what custom emotes you currently have running."] = "F\195\188ge einen |cff00ff00/emotes|r Befehl hinzu um zu sehen, welche Emotes Du derzeit benutzt." -- Needs review
...
\
|cff00ff00%t|r is your current target."] = "F\195\188gt Benutzer-Emotes hinzu. Bitte dran denken, dass der Charaktername immer das erste Wort sein wird.\
\
...
L["Adds the chat commands |cff00ff96/pets|r and |cff00ff96/mounts|r to provide information about your mounts and pets."] = "Adds the chat commands |cff00ff96/pets|r and |cff00ff96/mounts|r to provide information about your mounts and pets." -- Requires localization
...
L["Auto Ding"] = "Auto \"ding\"" -- Needs review
...
L["   |cff00ff00/ct %s|r - %s"] = true -- Needs review
...
L["   |cff00ff00%s|r or |cff00ff00%s|r - %s"] = "   |cff00ff00%s|r oder |cff00ff00%s|r - %s" -- Needs review
L["   |cff00ff00%s|r - %s"] = true -- Needs review
...
\
|cffff0000NOTE:|r  Wenn dieses Addon anf\195\164ngt eine erhebliche Menge an Speicher zu verbrauchen, einfach die Namensdaten zur\195\188cksetzen und es wird auf ein normales Niveau zur\195\188ckkehren.\
\
...
L[" |cffffff00%d|r Total Modules (|cff00ff00%d|r Enabled, |cffff0000%d|r Disabled)"] = " |cffffff00%d|r Anzahl der Module (|cff00ff00%d|rAktiviert, |cffff0000%d|r Deaktiviert)" -- Needs review
...
L["Color level by difficulty"] = "F\195\164rbe Stufe nach der Schwierigkeit."
...
L["Ding Messages"] = "\"Ding\" Nachrichten" -- Needs review
...
L["Enabling this will send a message to your chat whenever you change a zone with a list of the Battle Pets that are obtainable in the zone.  You have the option to filter them based on whether or not you own them.  This will also add the chat commands |cff00ff96/zonelist|r and |cff00ff96/zl|r to send the list whenever.  Even if you disable this the chat commands will still work."] = "Enabling this will send a message to your chat whenever you change a zone with a list of the Battle Pets that are obtainable in the zone.  You have the option to filter them based on whether or not you own them.  This will also add the chat commands |cff00ff96/zonelist|r and |cff00ff96/zl|r to send the list whenever.  Even if you disable this the chat commands will still work." -- Requires localization
...
L["Filtering Mode"] = "Filter-Modus" -- Needs review
...
L["Filters out Auction House system messages."] = "Auktionshaus-Systemnachrichten filtern." -- Needs review
...
L["How to filter any matches."] = "Auf welche Wiese die Suchergebnisse filtern." -- Needs review
...
L["Logs the lines that are filtered by the |cff00ff96%s|r, |cff00ff96%s|r, |cff00ff96%s|r, and |cff00ff96%s|r modules."] = "Protokolliert Zeilen, welche von den Modulen |cff00ff96%s|r, |cff00ff96%s|r, |cff00ff96%s|r, und |cff00ff96%s|r gefiltert werden." -- Needs review
...
L["Loss Color"] = "Verlust Farbe" -- Needs review
L["Mage"] = "Magier"
...
L["Maximum time, in seconds, to wait before bidding someone farewell."] = "Maximale Wartezeit in Sekunden vor dem Verabschieden." -- Needs review
...
|cff00ff00#achieve#|r - Der Erfolg, welcher abgeschlossen wurde." -- Needs review
...
|cff00ff00#guild#|r - Name deiner Gilde." -- Needs review
...
|cff00ff00#guild#|r - Name of your guild."] = "Nachrichtenwelche benutzt werden wenn jemand der Gilde beitritt.\
\
|cffFA6400Wildcards|r\
...
|cff00ff00#guild#|r - Sein aktueller Level." -- Needs review
...
L["Minimum level required for an achievement to not be filtered."] = "Minimales ben\195\182tigtes Level damit Erfolgsnachricht nicht gefiltert wird." -- Needs review
L["Minimum time, in seconds, to wait before bidding someone farewell."] = "Minimale Wartezeit in Sekunden vor Verabschiedung." -- Needs review
...
L["Minimum time, in seconds, to wait before welcoming someone."] = "Minimale Wartezeit (in Sekunden), bevor ein Neuling willkommen gehei\195\159en wird." -- Needs review
...
L["Monitor guild chat."] = "Beobachte Gildennachrichten" -- Needs review
L["Monitor party chat."] = "Beobachte Gruppennachrichten" -- Needs review
...
L["Multiple Achievement Messages"] = "Mehrfache Erfolgsnachrichten." -- Needs review
...
L["Nearby People"] = "Leute in der N\195\164he." -- Needs review
L["New Version Notify"] = "Benachrichtigung \195\188ber neue Version." -- Needs review
L["No"] = "Nein" -- Needs review
L["No custom emotes are currently being used."] = "Zur Zeit sind keine Benutzer-Emotes in Benutzung." -- Needs review
...
L["Percent Chance"] = "Prozentuale Chance" -- Needs review
...
L["Provides a |cff00ff00/gkick|r command, as it should be."] = "Integriert ein |cff00ff00/gkick|r Befehl, wie es sein sollte." -- Needs review
...
L["Provides options to color player names, add player levels, and add tab completion of player names."] = "Bietet Optionen zum f\195\164rben von Spielernamen, f\195\188gt Spielerlevel  hinzu und Tabulator Vervollst\195\164ndigung von Spielernamen." -- Needs review
...
Trenne den Befehl vom Text mit einem Doppelpunkt (\":\")." -- Needs review
...
L["Reported by %s"] = "Gemeldet durch %s" -- Needs review
...
L["Select a method for coloring player names"] = "W\195\164hle ein Methode zum Einf\195\164rben der Spielernamen." -- Needs review
...
L["Send Guild Messages"] = "Gildennachrichten versenden" -- Needs review
...
L["%s from |cff00ff00%s|r was blocked."] = "%s von |cff00ff00%s|r wurde geblockt." -- Needs review
L["Shaman"] = "Schamane"
...
\
|cff00ff00Zum Deaktivieren w\195\164hle \"None\"|r." -- Needs review
...
L["Spam Throttle"] = "Spam Verz\195\182gerung" -- Needs review
...
L["Suppress"] = "Unterdr\195\188cken" -- Needs review
L["Suppress Recount/Skada/TinyDPS output into a clickable link, or filter it entirely."] = "Fasse Recount/Skada/TinyDPS-Ausgaben zu einem klickbaren Link zusammen oder filtere komplett raus." -- Needs review
...
L["Talk to your group based on party/raid status."] = "Sprich zu deiner Gruppe abh\195\164ngig vom Gruppen/Raid-Status." -- Needs review
...
L["Text justification for ChatFrame %d."] = "Text Ausrichtung f\195\188r Chat-Fenster %d." -- Needs review
...
L["The default color to use to color names."] = "Standardfarbe welche zum Einf\195\164rben von Namen verwendet werden soll." -- Needs review
...
L["The name or ID of the material you'd like to track."] = "Name oder ID des Materials, dass Du verfolgen m\195\182chtest." -- Needs review
...
L["Use %sECT|r instead of %sElvUI_ChatTweaks|r in messages printed by the addon."] = "Use %sECT|r instead of %sElvUI_ChatTweaks|r in messages printed by the addon." -- Requires localization
L["Use Short Name"] = "Use Short Name" -- Requires localization
L["Use Tab Complete"] = "Benutze Tabulator Vervollst\195\164ndigung" -- Needs review
...
L["What to do with Recount/Skada/TinyDPS reports in this channel."] = "Was tun, wenn Recount/Skada/TinyDPS-Daten in dem Kanal gepostet werden." -- Needs review
...
L["Who to Congratulate?"] = "Was gibt es zu gratulieren?" -- Needs review
